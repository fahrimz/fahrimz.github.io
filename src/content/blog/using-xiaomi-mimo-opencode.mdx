...
If you got free tokens from a MiMo event, get your API key at [platform.xiaomimimo.com/console/plan-manage](https://platform.xiaomimimo.com/console/plan-manage).
